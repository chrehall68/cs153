...
public class ConstantDefinitions_P2 extends Converter_P2 {
    Object constantDefinition(ConstantDefinitionContext ctx) {
        ...
        String constantName = idCtx.entry.getName().toUpperCase();
        ...
        String str = toJavaString(constantCtx.value, constantCtx.typespec);

        code.emitStart();
        code.emit("private static final ");
        code.emitEnd(javaTypeName + " " + constantName + " = " + str + ";");
